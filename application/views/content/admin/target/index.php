            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="exampleCheck1">Vaksin 1</label>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-check">
                        <input type="checkbox" name="filter_vaksin" class="form-check-input filter-vaksin" id="filter-vaksin-2" value="vaksin2">
                        <label class="form-check-label" for="exampleCheck1">Vaksin 2</label>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="form-check">
                        <input type="checkbox" name="filter_vaksin" class="form-check-input filter-vaksin" id="filter-vaksin-3" value="vaksin3">
                        <label class="form-check-label" for="exampleCheck1">Vaksin 3</label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="mb-2 float-end">
                        <button type="button" class="btn btn-outline-primary show-tsp" onclick="showTsp()">Lihat Rute</button>
                    </div>
                    <div class="mb-2 float-end px-2">
                        <button type="button" class="btn btn-outline-primary draw-polyline" id="sambungkan_manual" onclick="sambungTitikManual()">Draw Polyline</button>
                    </div>
                    <div class="mb-2 float-end">
                        <button type="button" class="btn btn-outline-primary draw-polyline" onclick="tampilPolyline()">Show Polyline</button>
                    </div>
...
<section class="section">
    <div class="card">
        <div class="card-header">
            <?= 'Travel Salessman Problem' ?>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="result-tsp"></div>
            </div>
        </div>
    </div>
